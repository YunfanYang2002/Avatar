...
if __name__ == "__main__":
    ...
    if opt.resume:
        ...
        #print('now',now,'name',name,'opt.postfix',opt.postfix)
        #print('nowname',nowname);
        #print('os.getenv("LOGHOME")',os.getenv("LOGHOME"))
    ...
    try:
        ...
        import signal
        signal.signal(signal.SIGILL, melk) 
        signal.signal(signal.SIGFPE, divein)

        pytorch_total_params = sum(p.numel() for p in model.parameters() if p.requires_grad)
        print()
        #print("Printed number of trainable params", pytorch_total_params)
        print("Printed number of trainable params on main.py")
        #model.summarize()
        print()
