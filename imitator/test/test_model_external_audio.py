...
import sys
sys.path.append("D:\CODES\Avatar");
#print(sys.path);
...
class test_on_audio():
    ...
    def __init__(self):
        ...
        wav2vec_path="D:/CODES/Imitator/projects/dataset/voca_face_former/wav2vec2-base-960h";
        #wav2vec_path="facebook/wav2vec2-base-960h"
        #wav2vec_path=wav2vec_path.decode('gbk');
        #print(wav2vec_path);
        ...
        template_file="D:/CODES/Imitator/projects/dataset/voca_face_former/templates.pkl"
        with open(template_file, 'rb') as handle:
            self.templates = pickle.load(handle, encoding='latin1')
            #self.templates = torch.load(handle)
        print("init end");
